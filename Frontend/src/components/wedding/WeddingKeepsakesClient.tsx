...
interface WeddingKeepsakesClientProps {
  products: any[];
}

export default function WeddingKeepsakesClient({ products }: WeddingKeepsakesClientProps) {
  ...
  return (
    <>
      {/* Sub-category Filter Tabs in Banner */}
      <div className="max-w-[1360px] mx-auto px-4 sm:px-6 lg:px-8 mb-6">
      ...
      <section
        ...
        className="max-w-[1360px] mx-auto px-4 sm:px-6 lg:px-8 w-full pb-12 sm:pb-16 scroll-mt-32"
      >
        ...
        {activeFilterCount > 0 && (
          <div className="mb-4 flex flex-wrap items-center gap-2 p-3 bg-surface-container-lowest rounded-xl border border-outline-variant/30 text-xs shadow-2xs">
            ...
            <Button
              ...
              size="sm"
              onClick={handleResetFilters}
              className="text-xs text-primary font-bold ml-auto h-auto p-0 cursor-pointer"
            >
              Clear All
            </Button>
          </div>
            ...
            {paginatedProducts.length > 0 ? (
                      ...
                      <CardContent className="p-4 sm:p-5 flex flex-col flex-1 justify-between gap-3">
                        ...
                        <div className="flex flex-col gap-3 pt-3 border-t border-outline-variant/20">
                          ...
                          <Button
                            ...
                            className="w-full bg-primary hover:bg-[#5f4b2d] text-on-primary text-xs font-semibold uppercase tracking-wider shadow-xs gap-2 cursor-pointer"
                          >
              ...
              <div className="bg-surface-container-lowest p-12 rounded-xl text-center border border-outline-variant/30 flex flex-col items-center">
                ...
                <Button
                  type="button"
                  onClick={handleResetFilters}
                  className="mt-4 bg-primary hover:bg-[#5f4b2d] text-on-primary text-xs font-semibold uppercase tracking-wider shadow-xs cursor-pointer"
                >
                  Reset All Filters
                </Button>
              </div>
                ...
                <div className="flex items-center gap-1">
                  ...
                  {currentPage < totalPages && (
                    <Button
                      ...
                      className="h-9 text-xs font-semibold uppercase tracking-wider gap-1 cursor-pointer"
                    >
                      <span>Next</span>
