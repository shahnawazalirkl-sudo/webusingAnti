...
export const MilestoneTracker = ({ milestones = [] }: { milestones?: { id: string; tag: string; icon: string; title: string; description?: string; tierBadge?: string; valueBadge?: string; valueColor?: string }[] }) => {
