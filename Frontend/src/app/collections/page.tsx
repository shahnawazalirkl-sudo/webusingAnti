...
import CollectionsFilterPills from '@/components/collections/CollectionsFilterPills';
import { resolveCategory } from '@/lib/collections';
import SovereignBookmarkButton from '@/components/collections/SovereignBookmarkButton';
import CollectionsConsultationForm from '@/components/collections/CollectionsConsultationForm';
import CollectionsCountdown from '@/components/collections/CollectionsCountdown';

export const metadata: Metadata = {
  title: 'Curated Signature Collections | ASRA Wedding Canvas',
  description: 'Explore masterfully curated wedding suites, gift vaults, bridal party tributes, and commemorative luxury hampers tailored by theme and celebration.',
  openGraph: {
    title: 'Curated Signature Collections | ASRA Wedding Canvas',
    description: 'Explore masterfully curated wedding suites, gift vaults, bridal party tributes, and commemorative luxury hampers tailored by theme and celebration.',
    url: 'https://asraweddingcanvas.com/collections',
...
export default async function CollectionsPage({ searchParams }: CollectionsPageProps) {
  ...
  const currentCategory = resolveCategory(resolvedParams?.category || resolvedParams?.cat);

  const filteredCollections = currentCategory === 'All Collections'
    ? COLLECTIONS_DATA
    : COLLECTIONS_DATA.filter((item) =>
        item.category === currentCategory ||
        item.additionalCategories?.includes(currentCategory)
      );
    ...
    <div className="w-full bg-surface min-h-screen text-on-surface">
      <div className="flex flex-col w-full">
        ...
        <div className="relative w-full overflow-hidden">
          ...
          {/* Filter Bar / Quick Category Chips (Extracted Client Component) */}
          <section className="max-w-[1360px] mx-auto px-4 sm:px-6 lg:px-8 mb-6 sm:mb-10">
            <CollectionsFilterPills totalCount={COLLECTIONS_DATA.length} />
          </section>
                ...
                <div>
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 sm:gap-4">
                    ...
                    <div className="flex items-center gap-2 w-full sm:w-auto">
                      ...
                      <SovereignBookmarkButton productId="sovereign-bridal-suite" />
                    </div>
                  </div>
                </div>
              </div>
          ...
          {/* 8 Signature Collections Bento Grid */}
          <section
            id="products"
          ...
          <section className="max-w-[1360px] mx-auto px-4 sm:px-6 lg:px-8 mb-10 sm:mb-12">
            <div className="bg-surface-container-low rounded-xl p-6 sm:p-8 lg:p-10 relative overflow-hidden shadow-xs border border-outline-variant/30">
              ...
              <div className="flex flex-col lg:flex-row items-center justify-between gap-8 relative z-10">
                ...
                {/* Quick Consultation Form Card (Extracted Client Component) */}
                <CollectionsConsultationForm />
              </div>
            </div>
          </section>
